...
You can find the most recent version of this guide [here](https://github.com/reactory-net/reactory-client/blob/master/packages/react-scripts/template/README.md).
