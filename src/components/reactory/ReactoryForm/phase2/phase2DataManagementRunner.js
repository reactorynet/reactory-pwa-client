...
// Phase 2.2 Data Management Optimization Test Runner
// Runs data management tests in Node.js environment
...
console.log('🚀 Phase 2.2 Data Management Optimization Test Runner');
...
try {
  ...
  const testModule = require('./phase2DataManagementTests.js');
  
  // Run the main test suite
  if (testModule.runDataManagementTests) {
    testModule.runDataManagementTests();
  } else {
