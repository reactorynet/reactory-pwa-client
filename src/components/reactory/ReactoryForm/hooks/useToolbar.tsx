...
if (uiOptions && reactory.utils.lodash.isNil(uiOptions.showSubmit) === false) {
...
if (uiOptions && reactory.utils.lodash.isNil(uiOptions.showRefresh) === false) {
...
const RefreshButton = () => {
  if (showRefresh === true) {
    return (
      <Button onClick={() => { refresh() }} variant="text" color="primary">
        <Icon>refresh</Icon>
      </Button>
    )
  }
...
const FormToolbar = () => (
  <Toolbar style={uiOptions.toolbarStyle || {}}>
    ...
    SchemaSelector ? <SchemaSelector /> : null}
    ...
    {formDefinition.helpTopics && showHelp === true && <Button variant="text" onClick={() => { toggleHelp() }} color="primary"><Icon>help</Icon></Button>}
  </Toolbar>
);
