...
const GridLayoutWidgetNEW = (props) => {
  ...
  return (
    <div>THIS IS THE TABLE GRID COMPONENT</div>
  );
}
...
const GridLayoutComponent = compose(withApi, withStyles(ReactoryMaterialTableStyles))(GridLayoutWidgetNEW)
export default GridLayoutComponent;
