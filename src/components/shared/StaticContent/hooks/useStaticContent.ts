...
export const toDraft = (
  ...
  enableComments: record?.enableComments ?? false,
  commentLayout: (record?.commentLayout as any) || 'bottom',
  commentsProps: (record?.commentsProps as Record<string, any>) || {},
  container: record?.container || 'Box',
  containerProps: (record?.containerProps as Record<string, any>) || {},
  style: (record?.style as Record<string, any>) || {},
  roles: record?.roles || [],
  ...
  const saveContent = useCallback(
    async (draft: ContentDraft): Promise<ReactoryStaticContent> => {
      ...
      const createInput = {
        ...
        commentLayout: draft.commentLayout,
        commentsProps: draft.commentsProps,
        container: draft.container,
        containerProps: draft.containerProps,
        style: draft.style,
        roles: draft.roles,
