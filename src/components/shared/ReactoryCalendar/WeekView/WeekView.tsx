...
import { getWeekDays, getTimeSlots, isWorkingHour } from "../utils/dateUtils";
import {
                ...
                {positioned.map((pe) => {
                  ...
                  const defaultRender = () => (
                    <EventCard
                      ...
                      onDragStart={(ev, e) =>
                        // Hook into drag-drop via consumer
                        undefined
                      }
                      onResizeStart={(ev, type, e) =>
                        // Hook into resize via consumer
                        undefined
                      }
                    />
                  );
