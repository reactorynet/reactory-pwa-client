...
export const Ruler = React.forwardRef((props, context) => {
  const theme = useTheme();
  let _style = { fill: "none", stroke: "#000", strokeLinejoin: "round", strokeWidth: "2px" };
  let fill = "#000000";
...
export const Briefcase = React.forwardRef((props, context) => {
  const theme = useTheme();
  let _style = { fill: "none", stroke: "#000", strokeLinejoin: "round", strokeWidth: "2px" };
  let fill = "#000000";
