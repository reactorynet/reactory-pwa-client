...
const ignoreResourceRegExp = /^\.\/locale$/
const ignoreCheckResourceRegExp = /moment$/
// This is the production and development configuration.
// It is focused on developer experience, fast rebuilds, and a minimal bundle.
export default function(webpackEnv): WebpackConfiguration {
  ...
  const getHtmlWebpackOptions = (): HtmlWebpackOptions => {

    let htmlWebpackOptions: HtmlWebpackOptions = {
      inject: "body",      
      template: paths.appIndexTemplate,
      title: process.env.REACT_APP_TITLE || "Reactory",
    };

    let productionConfig = isEnvProduction
      ? {
        minify: {
          removeComments: true,
  ...
  return {
    mode: isEnvProduction === true ? 'production' :  'development',
    ...
    resolve: {
      ...
      fallback: [ 
        {
          name: "crypto",
          alias: "crypto-browserify"
        },
        {
          name: "stream",
          alias: "stream-browserify"
        },
        {
          name: "url",
          alias: "url"
      ...
      rules: [        
        ...
        },
        {
          ...
          oneOf: [
            ...
            {
              test: /\.(png|jpe?g|gif|svg|eot|ttf|woff|woff2)$/, //[/\.bmp$/, /\.gif$/, /\.jpe?g$/, /\.png$/],
